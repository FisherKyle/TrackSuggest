window.__EVERNOTE_I18N__ = {
 "generatedOn": "2016-Aug-17 15:00 PDT",
 ...
 "GnomeChoice.InfoPageComponent.header.enforcement": "Your current plan has changed",
 ...
 "GnomeChoice.InfoPageComponent.description.enforcement": "As someone who uses Evernote on multiple devices, you should be aware of a change. Your Evernote Basic account can access your notes on a maximum of {{ 1 }}{{ 0 }} devices{{ 2 }}.",
 "GnomeChoice.InfoPageComponent.upgrade": "{{ LINKSTART }}Upgrade{{ LINKEND }} to continue using Evernote on more than {{ BOLDSTART }}{{ DEV_PLURAL:{{ DEV }} device|{{ DEV }} devices }}{{ BOLDEND }}.",
 "GnomeChoice.InfoPageComponent.upgrade.incentive.percentOff": "To continue using Evernote on more than {{ BOLDSTART }}{{ DEV_PLURAL:{{ DEV }} device|{{ DEV }} devices }}{{ BOLDEND }}, {{ LINKSTART }}upgrade at {{ PCT }}% off{{ LINKEND }}.",
 "GnomeChoice.InfoPageComponent.upgrade.incentive.freeTrial": "To continue using Evernote on more than {{ BOLDSTART }}{{ DEV_PLURAL:{{ DEV }} device|{{ DEV }} devices }}{{ BOLDEND }}, {{ LINKSTART }}try Evernote Premium free for {{ DAYS_PLURAL:{{ DAYS }} day|{{ DAYS }} days }}{{ LINKEND }}.",
 "GnomeChoice.InfoPageComponent.upgrade.incentive.bonusMonths": "To continue using Evernote on more than {{ BOLDSTART }}{{ DEV_PLURAL:{{ DEV }} device|{{ DEV }} devices }}{{ BOLDEND }}, {{ LINKSTART }}upgrade to Evernote Premium and get {{ MONTHS_PLURAL:{{ MONTHS }} month|{{ MONTHS }} months }} for free{{ LINKEND }}.",
 ...
 "GnomeChoice.ChoicePageComponent.description": "Upgrade now to access your notes on all {{ BOLDSTART }}{{ DEV }} of your devices{{ BOLDEND }}.",
 "GnomeChoice.ChoicePageComponent.description.incentive.percentOff": "Upgrade now and get {{ PCT }}% off Evernote Premium. Access your notes on all {{ BOLDSTART }}{{ DEV }} of your devices{{ BOLDEND }}.",
 "GnomeChoice.ChoicePageComponent.description.incentive.freeTrial": "Upgrade now and get a {{ DAYS }} day free trial of Evernote Premium. Access your notes on all {{ BOLDSTART }}{{ DEV }} of your devices{{ BOLDEND }}.",
 "GnomeChoice.ChoicePageComponent.description.incentive.bonusMonths": "Upgrade now and get {{ MONTHS_PLURAL:{{ MONTHS }} month|{{ MONTHS }} months }} of Evernote Premium for free. Access your notes on all {{ BOLDSTART }}{{ DEV }} of your devices{{ BOLDEND }}.",
 "GnomeChoice.ChoicePageComponent.upgrade.incentiveCallout.percentOff": "Upgrade at {{ 0 }}% off",
 "GnomeChoice.ChoicePageComponent.upgrade.incentiveCallout.freeTrial": "Try Premium for free",
 "GnomeChoice.ChoicePageComponent.upgrade.incentiveCallout.bonusMonths": "Upgrade and get {{ 0 }} free months",
 ...
 "GnomeChoice.ManageDevicesPageComponent.incentive.freeTrial": "{{ 0 }} day free trial",
 ...
 "GnomeChoice.ConfirmRevokePageComponent.upgrade.incentive.bonusMonths": "Upgrade and get {{ 0 }} months free",
 ...
 "CheckoutInfoPane.youArePurchasingAnnual.alipay": "You are purchasing an Evernote annual subscription. Your Alipay account will be charged {{ 0 }}. This subscription will automatically renew.",
 ...
 "CheckoutInfoPane.youArePurchasingMonthly.alipay": "You are purchasing an Evernote monthly subscription. Your Alipay account will be charged {{ 0 }}. This subscription will automatically renew.",
 ...
 "MultitierCheckoutAction.basic.chooseToDowngradeWarning": "If you choose to downgrade to Basic, you\u2019ll no longer have {{ 0 }} features and access to your notes will be limited to {{ 1 }} devices.",
 ...
 "MultitierCheckoutAction.tiers.billedAnnually": "billed annually at {{ 0 }}",
 ...
 "AddWelcomeNotesAction.welcomeNotebookName": "Sample Notebook",
 ...
 "ConnectedServicesAction.linkedin.desc": "Connect with LinkedIn to enable easy sharing to your friends.",
 ...
 "ConnectedServicesAction.wsj.title": "The Wall Street Journal",
 "ConnectedServicesAction.wsj.desc": "Connect with The Wall Street Journal to view more related articles while you work.",
 ...
 "ConnectedServicesAction.nikkei.desc": "Connect with Nikkei to view more related articles while you work.",
 ...
 "ConnectedServicesAction.salesforce.desc": "Connect with Salesforce to instantly turn business cards into contacts and leads.",
 ...
 "noteVersions.text.2": "Clicking on a note will show you the content of the saved version. You can copy and paste that content, if you wish. Alternatively, click Export to download the note. Once downloaded, the note can be imported using the Import option in the File menu of Evernote for Windows or Evernote for Mac.",
 ...
 "BusinessHomeAction.notebook.list.preview.joinedBadge": "joined",
 ...
 "BusinessHomeAction.notebooks.button.joinNotebook": "Join Notebook",
 "BusinessHomeAction.notebooks.button.leaveNotebook": "Leave Notebook",
